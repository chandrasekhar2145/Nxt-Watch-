      ...
      return (
        <NavHeader isDarkTheme={isDarkTheme}>
          ...
          <OptionsContainer>
            ...
            >
              {isDarkTheme ? (
                <FiSun color="#ffffff" size={25} aria-label="close" />
              ) : (
                <BsMoon size={25} aria-label="close" />
              )}
            </DarkModeButton>
            <UserProfileImage
            ...
            <MobileMenuButton type="button">
              {isDarkTheme ? (
                <GiHamburgerMenu color="#ffffff" size={25} aria-label="close" />
              ) : (
                <GiHamburgerMenu color="#000000" size={25} aria-label="close" />
              )}
            </MobileMenuButton>
            <Popup
              modal
